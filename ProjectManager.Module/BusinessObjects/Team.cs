...
namespace ProjectManager.Module.BusinessObjects
{
    ...
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        ...
        public string TeamDescription
        {
            ...
            set { SetPropertyValue(nameof(TeamDescription), ref _TeamDescription, value); }
        }

        //[Association("Team-Project")]
        ...
        public XPCollection<ApplicationUser> Members
        {
            get { return GetCollection<ApplicationUser>(nameof(Members)); }
        }
