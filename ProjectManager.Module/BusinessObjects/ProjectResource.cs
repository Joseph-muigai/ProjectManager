...
namespace ProjectManager.Module.BusinessObjects
{
    ...
    public class ProjectResource : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        ...
        public string ResourceName
        {
            ...
            set { SetPropertyValue(nameof(ResourceName), ref _ResourceName, value); }
        }
        private string _ResourceDescription;
        public string ResourceDescription
        {
            get { return _ResourceDescription; }
            set { SetPropertyValue(nameof(ResourceDescription), ref _ResourceDescription, value); }
        }
        private FileData _ResourceFile;
        public FileData ResourceFile
        {
            get { return _ResourceFile; }
            set { SetPropertyValue(nameof(ResourceFile), ref _ResourceFile, value); }
        }
