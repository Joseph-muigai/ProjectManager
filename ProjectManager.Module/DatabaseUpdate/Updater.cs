...
public class Updater : ModuleUpdater {
    ...
    public override void UpdateDatabaseAfterUpdateSchema() {
        ...
        //if (ObjectSpace.GetObjects<ProjectsDashboard>().Count == 0)
        //{
        //    ProjectsDashboard dashboard = ObjectSpace.CreateObject<ProjectsDashboard>();
        //    // Configure the dashboard as needed
        //    dashboard.Name = "Projects Dashboard";
        //    dashboard.Owner = ObjectSpace.FirstOrDefault<PermissionPolicyUser>(u => u.UserName == "Admin");
        //    dashboard.Layout = "<DashboardLayout><Groups><Group Caption=\"Group 1\"><DashboardItem Name=\"Item 1\" /></Group></Groups><Items><Item Name=\"Item 1\" Type=\"DevExpress.DashboardCommon.DashboardTable\" /></Items></DashboardLayout>";
